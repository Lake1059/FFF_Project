...
Partial Class Form支持者
    ...
    Private Sub InitializeComponent()
        ...
        ModernPanel1.TabIndex = 128
        ' 
        ' MemberWall1
        ' 
        MemberWall1.BackColor = Color.Transparent
        MemberWall1.CardBorderSize = 0
        MemberWall1.CardHoverOverlayColor = Color.FromArgb(CByte(20), CByte(200), CByte(200), CByte(200))
        MemberWall1.CardMinHeight = 1
        MemberWall1.CardMinWidth = 1
        MemberWall1.CardPressedOverlayColor = Color.FromArgb(CByte(40), CByte(200), CByte(200), CByte(200))
        MemberWall1.CardRadius = 10
        MemberWall1.CardSpacing = 10
        MemberWall1.Dock = DockStyle.Fill
        MemberWall1.Location = New Point(20, 102)
        ...
        MemberWall1.Size = New Size(760, 328)
        MemberWall1.TabIndex = 130
        ' 
        ' Panel4
        ' 
        ...
        Panel4.Controls.Add(ModernButton4)
        Panel4.Controls.Add(JustEmptyControl3)
        Panel4.Controls.Add(ModernButton3)
        Panel4.Controls.Add(JustEmptyControl2)
        Panel4.Controls.Add(ModernButton2)
        ...
        ModernButton5.Location = New Point(610, 10)
        ...
        JustEmptyControl5.Location = New Point(600, 10)
        ...
        ModernTextBox1.Location = New Point(400, 10)
        ...
        ModernButton4.Size = New Size(70, 32)
        ModernButton4.TabIndex = 10
        ModernButton4.Text = "清除"
        ' 
        ' JustEmptyControl3
        ' 
        ...
        ModernButton3.Size = New Size(110, 32)
        ModernButton3.TabIndex = 8
        ModernButton3.Text = "免费赠送的"
        ' 
        ' JustEmptyControl2
        ' 
        JustEmptyControl2.Dock = DockStyle.Left
        JustEmptyControl2.Location = New Point(190, 10)
        ...
        ModernButton1.ForeColor = Color.Gainsboro
        ...
        HtmlColorLabel2.Size = New Size(760, 20)
        HtmlColorLabel2.TabIndex = 128
