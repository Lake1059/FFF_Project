...
Public Module 录制交互
    ...
    Public Sub 开始录制()
        ...
        Try
            ...
            视频配置.设置色彩模式(设置.实例对象.色彩模式 = 1,
                设置.实例对象.SDR亮度, 设置.实例对象.HDR峰值)
    ...
    Private Sub 写入录制配置日志(源 As 视频源条目, 音频 As 音频源条目,
        ...
        写日志($"色彩处理：SDR白电平={设置.实例对象.SDR亮度} nit，HDR标称峰值={设置.实例对象.HDR峰值} nit，色彩范围={配置.色彩范围}", False)
